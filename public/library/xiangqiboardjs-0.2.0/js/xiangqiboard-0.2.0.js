...
;(function () {
  ...
  function constructor (containerElOrString, config) {
    ...
    var draggedPieceSource = null
     ...
     var currentSelectedPieceSource = null
     var currentSelectedPieceTarget = null



    var isDragging = false
    var isSelectedPiece = false
    ...
    function snapbackDraggedPiece () {
      ...
      var sourceSquarePosition = $('#' + squareElsIds[currentSelectedPieceSource]).offset()
    ...
    function dropDraggedPieceOnSquare (square) {
      ...
      function onAnimationComplete () {
        ...
        if (isFunction(config.onSnapEnd)) {
          config.onSnapEnd(currentSelectedPieceSource, square, currentSelectedPieceTarget)
        }
      }
     ...
     // determine what the action should be
      ...
      if (isFunction(config.onDrop)) {
        ...
        if (draggedPieceSource === 'spare' && validSquare(location)) {
          ...
          newPosition[location] = currentSelectedPiece
        }
   ...
   function isPieceCanMoveToSquare(square,target){
    ...
    function setHighlight(element,location) {

        config.onClickOutPiece()
        var isClickOnPiece =element.find('img').length ? true :false

        if(currentSelectedPieceSource){
            /*
            * reset highlight
            * */

            $('#' + squareElsIds[currentSelectedPieceSource]).removeClass(CSS.highlight2)
        }
            ...
            * */
            ...
            if(currentPosition.hasOwnProperty(location)){
                ...
                if(currentPieceTurn == config.xiangqi.turn()){
                    ...
                    currentSelectedPieceSource = location
                    ...
                    if(currentSelectedPieceSource && currentSelectedPiece){
                        ...
                        if(isPieceCanMoveToSquare(currentSelectedPieceSource,location)){
